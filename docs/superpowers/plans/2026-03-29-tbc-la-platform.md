...
**Repo:** `/Users/ops/Dropbox/Seattle/burnham-civic-site`
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/index.html`
...
```bash
cd /Users/ops/Dropbox/Seattle/burnham-civic-site
git add index.html
...
```bash
mkdir -p /Users/ops/Dropbox/Seattle/burnham-civic-site/la
```
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/index.html`
...
```bash
node -c /Users/ops/Dropbox/Seattle/burnham-civic-site/la/gate.js
```
...
async function main() {
  ...
  fs.writeFileSync('/Users/ops/Dropbox/Seattle/burnham-civic-site/la/lahsa-data.js', js);
...
```bash
head -50 /Users/ops/Dropbox/Seattle/burnham-civic-site/la/lahsa-data.js
```
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/lahsa.html`
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/lafd.html`
...
```bash
open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/lapd.html
cd /Users/ops/Dropbox/Seattle/burnham-civic-site
...
```bash
open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/dwp.html
cd /Users/ops/Dropbox/Seattle/burnham-civic-site
git add la/dwp.html
...
```bash
open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/transit.html
cd /Users/ops/Dropbox/Seattle/burnham-civic-site
...
```bash
open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/building.html
cd /Users/ops/Dropbox/Seattle/burnham-civic-site
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/cabinet.html`
...
```bash
node -c /Users/ops/Dropbox/Seattle/burnham-civic-site/la/network-data.js
```
...
Run: `open /Users/ops/Dropbox/Seattle/burnham-civic-site/la/network.html`
