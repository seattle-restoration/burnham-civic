// gate.js - Password gate for restricted America pages
// Password: 'fraser', cookie: tbc_america_auth, 30-day expiry
(function() {
  var PASS = 'fraser';
  var COOKIE = 'tbc_america_auth';
  var DAYS = 30;
  ...
  function setCookie(name, val, days) {
    ...
    document.cookie = name + '=' + val + ';expires=' + d.toUTCString() + ';path=/america/';
  }
